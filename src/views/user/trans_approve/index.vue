        ...
        <template #operation="{ record }">
          <div class="btn">
            <template v-if="!record.checked">
              <a-button type="primary" ghost @click="onApproved(true, record)" size="small">通过</a-button>
              <a-button type="primary" ghost class="m_l_10" @click="onApproved(false, record)" size="small"
                >拒绝</a-button
              >
            </template>
          </div>
