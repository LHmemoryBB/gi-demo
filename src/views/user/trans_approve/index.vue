<script setup>
	...
	import { useAxios, openChangeStatus } from '@/hooks'
	...
	<div class="page-container">
		...
		<div class="table-container">
			<Ttable :loading="loading" :headers="headers" :tableData="data" :pages="pages">
				<template #paymentCode="{record}">
					<img style="width: 100px; height: 100px" :src="record.paymentCode" fit />
				</template>

				<template #operation="{record}">
					<div class="btn">
						<template v-if="!record.checked">
							<a-button type="primary" text @click="onApproved(true,record)" size="small">通过</a-button>
							<a-button type="primary" text class="m_l_10"  @click="onApproved(false,record)" size="small">拒绝</a-button>
						</template>
					</div>
				</template>
			</Ttable>
