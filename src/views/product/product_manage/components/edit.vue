<script setup>
	import { ref, computed, toRaw, reactive, defineEmits, defineExpose,
	...
	const { loading:loadingDetail, onSuccess:onSuccessDetail, onError:onErrorDetail, send:sendDetail } = useAxios(getProductDetail,{
		immediate:false
	});
...
<template>
	<Tdialog :Update="Update" :loading="loading || loadingDetail" @confirm="confirm" @close="close">
