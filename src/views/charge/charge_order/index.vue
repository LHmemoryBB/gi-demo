...
// 获取验单详情
const { loading: OrderDetailLoading, send: OrderDetailSend, onSuccess: OrderDetailSuccess, onError: OrderDetailError } = useAxios(orderChargeInfoDetail, {
  immediate: false,
});
  ...
  <div>
    ...
    <div class="content">
      ...
      >
        ...
        <template #reportState="{ scope }">
          {{scope.row.reportState? '成功': '失败'}}
        </template>
